...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          -- NOTE: using utility function in lua
      ...
      --  To check the current status of installed tools, use :Mason
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, options)
      ...
      -- TODO: extra config for treesitter:
  ...
  -- NOTE: Uncomment the following line and add your plugins to `lua/custom/plugins/*.lua` to get going.
